  ...
  <header>
    ...
    <nav>
      <ul class="nav-links">
        ...
        <li><a href="menu.php" class="nav-link">Collections</a></li>
    ...
    <div class="actions">
        <?php if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] === true): ?>
            <!-- <a href="liked.html"><i class="fas fa-heart"></i></a> -->
            <a href="liked.php"><i class="fas fa-heart" style="font-size: 20px; color: black; margin: 3px;"></i></a>
